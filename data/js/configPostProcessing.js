            ...
            function (data) {
                if (data == "invalid") {
                    $('#naming_pattern').qtip('option', {
                        'content.text': 'Ce modèle est invalide.',
                    ...
                    $('#naming_pattern').qtip('option', {
                        'content.text': 'Ce modèle ne serait pas valide sans les dossiers, l\'utiliser forcera le mode dossier pour tous les spectacles.',
                        'style.classes': 'ui-tooltip-rounded ui-tooltip-shadow ui-tooltip-red'
                    });
                    $('#naming_pattern').qtip('toggle', true);
