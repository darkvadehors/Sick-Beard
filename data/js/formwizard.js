...
formtowizard.prototype={
	...
	init:function(setting){
		...
		jQuery(function($){ //on document.ready
			...
			var $paginatediv=$('<div class="formpaginate" style="overflow:hidden;"><span class="prev" style="float:left">Prev</span> <span class="status">Step 1 of </span> <span class="next" style="float:right">Suiv</span></div>')
